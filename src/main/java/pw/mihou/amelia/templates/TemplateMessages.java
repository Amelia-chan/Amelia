...
public class TemplateMessages {
    ...
    public static final String ERROR_NO_USERS_FOUND = "❌ Amelia cannot found any users that matches the query, how about trying something else?";
    public static final String ERROR_SCRIBBLEHUB_NOT_ACCESSIBLE = "❌ Failed to connect to ScribbleHub. It's possible that the site is down or having issues.";
    public static final String ERROR_RSSSCRIBBLEHUB_NOT_ACCESSIBLE = "❌ Amelia was unable to fetch the RSS feed from ScribbleHub, this can happen because of either the user doesn't have a story published yet or ScribbleHub's RSS server is down.";

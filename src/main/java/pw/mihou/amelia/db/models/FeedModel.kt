package pw.mihou.amelia.db.models

import java.util.Date
import org.bson.Document
import pw.mihou.amelia.db.models.interfaces.BsonModel
import pw.mihou.amelia.db.models.interfaces.ObjectModel
...
data class FeedModel(
    ...
    companion object : ObjectModel<FeedModel> {
        override fun from(bson: Document): FeedModel =
            FeedModel(
